...
from keras.layers import Dense, Flatten, Conv2D, MaxPooling2D, Dropout, Activation, Input, UpSampling2D, AveragePooling2D, BatchNormalization, Lambda
...
if not os.path.exists(_folder):
    try:
        ...
        logger.warning('Unable to create folder for configuration file.',
                       exc_info=True)
